...
class CDoctorNetMenuIblockElementsComponent extends \CBitrixComponent {
    ...
    protected function checkModules() {
        foreach ($this->requiredModules as $moduleName) {
            if (!Loader::includeModule($moduleName)) {
                throw new SystemException(Loc::getMessage('COMPONENT_DOCTORNET_MENU_IBLOCK_ELEMENTS_NO_MODULE', [
                    '#MODULE#',
                    $moduleName
                ]));
            }
