...
$arComponentParameters = [
    ...
    'PARAMETERS' => array(
        'IBLOCK_TYPE'       => array(
            'PARENT'  => 'BASE',
            'NAME'    => Loc::getMessage('COMPONENT_DOCTORNET_MENU_IBLOCK_ELEMENTS_PARAMS_IBLOCK_LIST_TYPE'),
            'TYPE'    => 'LIST',
            'VALUES'  => $types,
            'DEFAULT' => 'news',
            'REFRESH' => 'Y',
        ...
        'IBLOCK_ID'         => array(
            'PARENT'            => 'BASE',
            'NAME'              => Loc::getMessage('COMPONENT_DOCTORNET_MENU_IBLOCK_ELEMENTS_PARAMS_IBLOCK_DESC_LIST_ID'),
            'TYPE'              => 'LIST',
            'VALUES'            => $iblocksList,
            'DEFAULT'           => "={$_REQUEST['ID']}",
            'ADDITIONAL_VALUES' => 'Y',
        ...
        'INCLUDE_ELEMENTS'  => array(
            'NAME' => Loc::getMessage('COMPONENT_DOCTORNET_MENU_IBLOCK_ELEMENTS_PARAMS_IBLOCK_INCLUDE_ELEMENTS'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'N',
        ),
